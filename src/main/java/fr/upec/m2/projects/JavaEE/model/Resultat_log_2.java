...
@NamedQueries({
        @NamedQuery(
                name = "Resultat_log_2.getAllResultByArrondissement",
                query = "SELECT _result.numero_arrendissement,_result.nom_du_candidat,_result.prenom_du_candidat,SUM(_result.nombre_de_voix_du_candidat)"
                        + "FROM Resultat_log_2 _result where _result.nom_du_candidat = :nomC AND _result.prenom_du_candidat = :prenomC GROUP BY _result.numero_arrendissement,_result.nom_du_candidat,_result.prenom_du_candidat"),

        @NamedQuery(
                name = "Resultat_log_2.getListCandidat",
                query = "SELECT _result.nom_du_candidat,_result.prenom_du_candidat,SUM(_result.nombre_de_voix_du_candidat),SUM(_result.nombre_de_votants) FROM Resultat_log_2 _result GROUP BY _result.nom_du_candidat,_result.prenom_du_candidat " ),
        @NamedQuery(
                name = "Resultat_log_2.getResultByName",
...
public class Resultat_log_2 extends Resultat implements Serializable {

    public Resultat_log_2() {
    }
    public Resultat_log_2(String numero_arrendissement, String numero_de_bureau_de_vote, String code_commune, String nombre_de_votants, String nombre_d_exprimes, String nom_du_candidat, String prenom_du_candidat, String nombre_de_voix_du_candidat,String nombre_inscrits) {
