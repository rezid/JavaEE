...
@Entity
public class Resultat_psd_2 implements Serializable {
    ...
    public Resultat_psd_2(@NotNull String numero_arrendissement, @NotNull String numero_de_bureau_de_vote, @NotNull String code_commune, @NotNull String nombre_de_votants, @NotNull String nombre_d_exprimes, @NotNull String nom_du_candidat, @NotNull String prenom_du_candidat, @NotNull String nombre_de_voix_du_candidat) {
